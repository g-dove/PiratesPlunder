...
PP.Repo        = PP.Repo or {}
PP.Repo.Guild  = PP.Repo.Guild or {}

---------------------------------------------------------------------------
-- GetData(guildKey)
-- THE canonical accessor for per-guild data.  Sandbox routing lives here.
---------------------------------------------------------------------------
function PP.Repo.Guild:GetData(guildKey)
...
-- GetRoster(guildKey)
---------------------------------------------------------------------------
function PP.Repo.Guild:GetRoster(guildKey)
...
---------------------------------------------------------------------------
function PP.Repo.Guild:GetSessions(guildKey)
    local gd = self:GetData(guildKey or PP:GetActiveGuildKey())
...
-- GetActiveSession()
---------------------------------------------------------------------------
function PP.Repo.Guild:GetActiveSession()
...
-- HasActiveSession()
---------------------------------------------------------------------------
function PP.Repo.Guild:HasActiveSession()
...
---------------------------------------------------------------------------
function PP.Repo.Guild:GetAllGuildKeys()
    local keys = {}
...
---------------------------------------------------------------------------
function PP.Repo.Guild:SetActiveSessionID(gk, id)
...
---------------------------------------------------------------------------
function PP.Repo.Guild:ClearActiveSessionID(gk)
    local gd = self:GetData(gk)
...
---------------------------------------------------------------------------
function PP.Repo.Guild:MarkSessionEnded(gk, sessionID, ts, reason)
    local gd = self:GetData(gk)
...
---------------------------------------------------------------------------
function PP.Repo.Guild:AddTombstone(gk, id, ver)
    local gd = self:GetData(gk)
    if not gd then return end
...
---------------------------------------------------------------------------
function PP.Repo.Guild:BumpRosterVersion(guildKey)
    local gd = self:GetData(guildKey or PP:GetActiveGuildKey())
...
-- GetRosterVersion(gk)
---------------------------------------------------------------------------
function PP.Repo.Guild:GetRosterVersion(gk)
    local gd = self:GetData(gk)
